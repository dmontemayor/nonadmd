...
Returns a character based double precision input. \par
 -\/-\/---character key-\/-\/-\/---\par
 \%+ \-: significant real positive value\par
 \%-\/ \-: significant real negative value\par
 \%$\ast$ \-: significant imag positive value\par
 ¬ \-: significant imag negative value\par
 \%. \-: insignificant value\par
 -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---\par
...
Returns a character representing the orientation of an input 2\-D vector. \par
 -\/-\/---character key-\/-\/-\/---\par
 \%. \-: insignificant magnitute\par
 \%-\/ \-: pi15/8 $<$ angle $<$ pi/8 achar(45)\par
 \%/ \-: pi/8 $<$ angle $<$ pi3/8 achar(47)\par
 \%$|$ \-: pi3/8 $<$ angle $<$ pi5/8 achar(124)\par
 \%\textbackslash{} \-: pi5/8 $<$ angle $<$ pi7/8 achar(92)\par
 \%-\/ \-: pi7/8 $<$ angle $<$ pi9/8\par
 \%/ \-: pi9/8 $<$ angle $<$ pi11/8\par
 \%$|$ \-: pi11/8 $<$ angle $<$ pi13/8\par
 \%\textbackslash{} \-: pi13/8 $<$ angle $<$ pi15/8\par
 -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---\par
