...
!<----------------------------------------------------------------------------
!> \details
!! Will try to generate observable for common type of Hamiltonians.
!<----------------------------------------------------------------------------
!>\authors
!! Daniel Montemayor
!!
...
!<----------------------------------------------------------------------------
!>\todo
!! Make list of common Hamiltonians.
!<-----------------------------------------------------------------------------
! !>\bug
! !<-----------------------------------------------------------------------------
!Change Log:
...
# include "config.h"
  ...
  left off here make generic spectrum object
