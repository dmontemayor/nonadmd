...
contains
  ...
  subroutine TEMPLATE_init(this,file)
    ...
    if(present(file))then
       ...
       if(check(file))call stop('TEMPLATE_init: cannot find input file '//file)
    ...
    if(check(file))call stop('TEMPLATE_init: failed final check!')
  ...
  subroutine TEMPLATE_update(this)
    ...
    !if(check(this))call stop('TEMPLATE_update: failed final check!')
  ...
  subroutine TEMPLATE_resample(this)
    ...
    call update(this)
    if(check(this))call stop('TEMPLATE_resample: failed final check!')
